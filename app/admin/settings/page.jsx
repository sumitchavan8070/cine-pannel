...
import { Save, AlertCircle, CheckCircle, Settings, CreditCard, BookOpen, FileCode, ExternalLink } from "lucide-react"
...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 max-w-3xl">
      ...
      <Card className="p-4 sm:p-6 bg-white border-0 shadow-xl">
        <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
          <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-purple-500 to-indigo-500 rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
            <BookOpen className="text-white" size={18} />
          </div>
          <h2 className="text-xl sm:text-2xl font-bold text-slate-900">Documentation</h2>
        </div>
        <div className="grid gap-3 sm:grid-cols-1 md:grid-cols-3">
          <Link
            href="/admin/docs/api"
            className="flex items-center gap-3 p-4 rounded-xl border-2 border-slate-200 hover:border-purple-300 hover:bg-purple-50/50 transition-all duration-200 group"
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-slate-500">Interactive Swagger UI</p>
            </div>
          </Link>
          <Link
            href="/admin/docs/admin-panel"
            className="flex items-center gap-3 p-4 rounded-xl border-2 border-slate-200 hover:border-purple-300 hover:bg-purple-50/50 transition-all duration-200 group"
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="font-semibold text-slate-900">Admin Panel Guide</p>
              <p className="text-sm text-slate-500">Usage documentation</p>
            </div>
          </Link>
          <Link
            href="/admin/docs/swagger"
            className="flex items-center gap-3 p-4 rounded-xl border-2 border-slate-200 hover:border-purple-300 hover:bg-purple-50/50 transition-all duration-200 group"
          >
            <div className="w-10 h-10 bg-gradient-to-br from-amber-500 to-orange-500 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
              <FileCode className="text-white" size={20} />
            </div>
            <div className="flex-1 min-w-0">
              <p className="font-semibold text-slate-900">Swagger YAML</p>
              <p className="text-sm text-slate-500">OpenAPI specification</p>
            </div>
          </Link>
        </div>
      </Card>
